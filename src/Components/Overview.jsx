...
const Overview = () => {
  ...
  return (
    <table className=" table lg:mx-auto md:mx-auto mx-12  my-6">
        ...
        <tr className="text-center  border-b border-gray-950 hover:bg-gray-300 bg-gray-200 last:border-b-0">
            ...
            {/* <th>Manufacturer</th> */}
            <th>Status</th>
            <th className="lg:table-cell hidden ">Installation date</th>
            <th className="lg:table-cell hidden">Last maintanance Date</th>
            <th>Details</th>
        </tr>
        </thead>
        <tbody>
        {
            dashboard.map((data) => {
                return <tr key={data._id} className="text-center  border-b border-gray-950 hover:bg-gray-300 bg-gray-200 last:border-b-0">
                    ...
                    <td className="md:table-cell hidden py-2 text-center capitalize px-3 text-sm">{data.location ? data.location : "data not found"}</td>
                    ...
                    <td className="lg:table-cell hidden py-2 text-center capitalize px-2 text-sm">{data.installationDate ? data.installationDate : "data not found"}</td>
                    <td className="lg:table-cell hidden py-2 text-center capitalize px-2 text-sm">{data.lastMaintanaceDate ? data.lastMaintanaceDate : "data not found"}</td>
